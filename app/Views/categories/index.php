        ...
        <div class="group relative bg-white p-6 rounded-2xl shadow-md border border-gray-100 transition-all hover:shadow-2xl hover:-translate-y-1">
            <div class="flex items-start justify-between mb-6">
                ...
                <div class="flex gap-1 items-center">
                    <a href="/categories/<?= $cat['id'] ?>/edit" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
                        <i data-lucide="pencil" class="size-4"></i>
                    </a>

                    <form action="/categories/<?= $cat['id'] ?>" method="POST" class="inline">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                <div class="flex items-center gap-2 px-3 py-1 bg-gray-50 rounded-full text-gray-600">
                    ...
                    <span class="text-xs font-bold"><?= $cat['productCount'] ?? 0 ?> Products</span>
                </div>
